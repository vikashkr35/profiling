...
namespace ParametricDramDirectoryMSI
{
   ...
   class CacheMasterCntlr
   {
      private:
         ...
         //................... neelam: CHANGE!!! Added mshr for structure data .............................
         Mshr mshr_struc;
         //.................................................................................................
   ...
   class CacheCntlr : ::CacheCntlr
   {
      private:
         ...
         struct {
           ...
           //extra statistics 
           UInt64 num_struc_ref;
           UInt64 struc_accesses_where[HitWhere::NUM_HITWHERES];
           UInt64 num_prop_ref;
           UInt64 prop_accesses_where[HitWhere::NUM_HITWHERES];
           UInt64 num_intermediate_ref;
           UInt64 intermediate_accesses_where[HitWhere::NUM_HITWHERES];           
           UInt64 memory_side_prefetches;  
           UInt64 hits_prefetch_struc;
           UInt64 hits_prefetch_prop;
           UInt64 prefetch_dropped;
           UInt64 num_late_prop_prefetch;
           UInt64 num_late_struc_prefetch;
           UInt64 num_internal_push;
           UInt64 prefetch_struc;
           UInt64 prefetch_prop;
           UInt64 demand_load_misses_struc, demand_store_misses_struc, demand_load_misses_prop, demand_store_misses_prop;
         ...
         //....................... neelam: CHANGE!!! added code for cleaning MSHR entries .......................
         void cleanupMshrStruc();
         //......................................................................................................
