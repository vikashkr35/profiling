...
class MemoryManagerBase
{
   ...
   public:
      ...
      MemoryManagerBase(Core* core, Network* network, ShmemPerfModel* shmem_perf_model):
         ...
         directed(false), //neelam: CHANGE!!! for cache bypassing
         addrRangeSet(false),  //neelam: CHANGE!!! for cache bypassing
         propRangeSet(false),   //neelam: CHANGE!!! for cache bypassing
         noPropRange(0),  //neelam: CHANGE!!! for cache bypassing
         startOutOffset(0), //neelam: CHANGE!!! for cache bypassing
         endOutOffset(0),    //neelam: CHANGE!!! for cache bypassing
         startInOffset(0), //neelam: CHANGE!!! for cache bypassing
         endInOffset(0),    //neelam: CHANGE!!! for cache bypassing 
         startOutNeigh(0), //neelam: CHANGE!!! for cache bypassing
         endOutNeigh(0),//neelam: CHANGE!!! for cache bypassing
         startInNeigh(0),//neelam: CHANGE!!! for cache bypassing
         endInNeigh(0),   //neelam: CHANGE!!! for cache bypassing   
         propStart1(0),//neelam: CHANGE!!! for cache bypassing
         propStart2(0),//neelam: CHANGE!!! for cache bypassing
         propStart3(0),    //neelam: CHANGE!!! for cache bypassing 
         propEnd1(0),//neelam: CHANGE!!! for cache bypassing
         propEnd2(0),//neelam: CHANGE!!! for cache bypassing
         propEnd3(0)        //neelam: CHANGE!!! for cache bypassing
      {}
