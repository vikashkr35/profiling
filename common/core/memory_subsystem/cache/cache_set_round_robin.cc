...
UInt32
CacheSetRoundRobin::getReplacementIndex(CacheCntlr *cntlr, bool isStruc, UInt32 set_index, UInt64 num_accesses)
{
...
void
CacheSetRoundRobin::updateReplacementIndex(UInt32 accessed_index, bool isStruc)
{
   return;
}
