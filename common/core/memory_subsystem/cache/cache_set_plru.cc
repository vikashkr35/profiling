...
UInt32
CacheSetPLRU::getReplacementIndex(CacheCntlr *cntlr, bool isStruc, UInt32 set_index, UInt64 num_accesses)
{
...
void
CacheSetPLRU::updateReplacementIndex(UInt32 accessed_index, bool isStruc)
{
   if (m_associativity == 4)
   {
