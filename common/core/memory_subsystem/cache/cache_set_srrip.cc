...
UInt32
CacheSetSRRIP::getReplacementIndex(CacheCntlr *cntlr, bool isStruc, UInt32 set_index, UInt64 num_accesses)
{
   for (UInt32 i = 0; i < m_associativity; i++)
   {
...
void
CacheSetSRRIP::updateReplacementIndex(UInt32 accessed_index, bool isStruc)
{
