...
Cache::insertSingleLine(IntPtr addr, Byte* fill_buff,
      ...
      SubsecondTime now, CacheCntlr *cntlr, bool isStruc)   //.... neelam: CHANGE!!! added isStruc ......
{
   IntPtr tag;
   UInt32 set_index;
   splitAddress(addr, tag, set_index);
   ...
   m_sets[set_index]->insert(cache_block_info, fill_buff,
         eviction, evict_block_info, evict_buff, cntlr, isStruc, set_index, m_num_accesses);  //.... neelam: CHANGE!!! added isStruc ......
