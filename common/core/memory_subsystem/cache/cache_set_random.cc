...
UInt32
CacheSetRandom::getReplacementIndex(CacheCntlr *cntlr, bool isStruc, UInt32 set_index, UInt64 num_accesses)
{
...
void
CacheSetRandom::updateReplacementIndex(UInt32 accessed_index, bool isStruc)
{
}
