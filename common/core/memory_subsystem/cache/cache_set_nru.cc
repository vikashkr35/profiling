...
UInt32
CacheSetNRU::getReplacementIndex(CacheCntlr *cntlr, bool isStruc, UInt32 set_index, UInt64 num_accesses)
{
...
void
CacheSetNRU::updateReplacementIndex(UInt32 accessed_index, bool isStruc)
{
