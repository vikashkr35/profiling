...
class CacheBase
{
   public:
      ...
      enum ReplacementPolicy
      {
         ...
         LRU,
         LRU_QBS,
         LRU_S_NS,  //.... neelam: CHANGE!!! added LRU_S_NS ....
         DRRIP_S_NS, //.... neelam: CHANGE!!! added DRRIP with separate cache ways for structure and non-structure data
        // LRU_S_NS_QBS,   //.... neelam: CHANGE!!! added LRU_S_NS ....
         NRU,
         MRU,
         NMRU,
         PLRU,
