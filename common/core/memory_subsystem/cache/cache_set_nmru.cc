...
UInt32
CacheSetNMRU::getReplacementIndex(CacheCntlr *cntlr, bool isStruc, UInt32 set_index, UInt64 num_accesses)
{
...
void
CacheSetNMRU::updateReplacementIndex(UInt32 accessed_index, bool isStruc)
{
   for (UInt32 i = 0; i < m_associativity; i++)
   {
