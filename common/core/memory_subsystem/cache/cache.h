...
class Cache : public CacheBase
{
   ...
   public:
      ...
      CacheBlockInfo* accessSingleLine(IntPtr addr,
            access_t access_type, Byte* buff, UInt32 bytes, SubsecondTime now, bool update_replacement, bool isStruc = false);   //.... neelam: CHANGE!!! added isStruc ......
      CacheBlockInfo* accessSingleLine_to_check_hit(IntPtr addr,
            access_t access_type, Byte* buff, UInt32 bytes, SubsecondTime now, bool update_replacement, bool isStruc = false);   //.... neelam: CHANGE!!! added isStruc ......      
      void insertSingleLine(IntPtr addr, Byte* fill_buff,
            bool* eviction, IntPtr* evict_addr,
            CacheBlockInfo* evict_block_info, Byte* evict_buff, SubsecondTime now, CacheCntlr *cntlr = NULL, bool isStruc = false);   //.... neelam: CHANGE!!! added isStruc ......
